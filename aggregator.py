...
def main():
    ...
    for feed_url in sites:
        ...
        try:
            ...
            for page in pages:
                ...
                # CRITICAL FIX: Preserve full URL for Google Share links
                if "share.google" in raw_url:
                    full_url = raw_url 
                elif raw_url.startswith("http"): 
                    full_url = raw_url
                else: 
                    full_url = f"{origin}/{raw_url.lstrip('/')}"
    ...
    grey_zone = { 
        "url": "https://share.google/1O2Kl72Vige48vGsB", 
        "score": 150, "category": "Auto", "description": "Automotive parts sales based in Pretoria, delivering nationwide.", "whatsapp": "27000000000", "location": "Pretoria, SA" 
    }
    ao_locksmith = { 
        "url": "https://share.google/WNjzMAwNlj9tC3u6F", 
        "score": 150, "category": "Service", "description": "Specialist car locksmith. Cutting, coding, and programming car keys.", "whatsapp": "27000000000", "location": "Pretoria, SA" 
    }
